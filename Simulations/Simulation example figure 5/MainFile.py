...
total_txt = 10  * saveResolutionFactor * 2


#activity information pulses
data_act = np.loadtxt('data_active_pulse.txt')
data_ref = np.loadtxt('data_refractory_pulse.txt')
...
#ref information pulses
i_ref = data_ref[:,0].tolist()
j_ref = data_ref[:,1].tolist()
ti_ref = data_ref[:,2].tolist()
delta_ref = data_ref[:,3].tolist()
